...
<html lang="en">
  <head>
    ...
    <title>Pemilihan Ketua Umum HMTI Polinema</title>
	...
	<nav class="navbar navbar-inverse navbar-static-top">
	  <div class="container">
		...
		<div class="navbar-header">
		  ...
		  <a class="navbar-brand" href="index.php">LAPORAN HASIL CALON KETUA UMUM</a>
		</div>
...
?>
	<br/>
	<div>
        <center><img src="images/hmti-favicon - Copy.png"> </center>
        <p>
        <center> <H3> HASIL LAPORAN CALON KETUA UMUM HMTI </H3></center>
	  ...
	  <div class="tab-content">
		...
		?>
            ...
            <right> <div class="btn btn-primary" style=" color: #ffff; font: "Courier New", Courier, monospace"   >CETAK HASIL<a id="cetak" >.</a>
            </right>
        </div>
        </div>
	  </div>
